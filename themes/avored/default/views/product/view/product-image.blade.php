@php
    $image = $product->image;
    $imageType = (isset($imageType)) ? $imageType : "url";
@endphp
...
@if(NULL !== $image)
    <div class="product-images-wrapper">
        ...
        @if(isset($extraImage) && true == $extraImage)
            <div id="product-extra-media" class="carousel mt-3 carousel-multi slide" data-interval="false" data-ride="carousel" style="display: none">
                ...
                @foreach($product->images as $productImage)
                    ...
                    <div class="carousel-item {{ $class }}">
                        <div class="media media-card">
                            <img src="{{ $productImage->path->url }}" data-main-image="{{ $productImage->path->url }}" class="img-thumbnail" width="100px" />
                        </div>
                    </div>
                @endforeach
            </div>
